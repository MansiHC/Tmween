...
class FullImageAttributeScreen extends StatefulWidget {
  FullImageAttributeScreen({
    Key? key,
    required this.image,
    required this.current,
  }) : super(key: key);
  final List<GalleryAndAttributeComArr> image;
  final int current;

  @override
  State<StatefulWidget> createState() {
    return FullImageAttributeScreenState();
  }
}

class FullImageAttributeScreenState extends State<FullImageAttributeScreen> {
        ...
        Container(
            ...
            child: CarouselSlider(
              items: widget.image
                ...
                imageProvider: item.largeImageUrl!.setNetworkImageProvider(),
                      ))
                  .toList(),
