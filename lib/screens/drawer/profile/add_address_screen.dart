                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Helper.isIndividual
                              ...
                              : _bottomView2(addressController),
                        ],
                      ))));
        });
  }

  Widget _bottomView2(AddAddressController addressController) {
    return Expanded(
                      ...
                      children: [
                        DropdownButtonHideUnderline(
                          child: DropdownButton2(
                            ...
                            items: addressController.countries2
                                .map((item) => DropdownMenuItem<CountryModel2>(
                                      value: item,
                                      child: Text(
                                        item.name,
                                ...
                                .toList(),
                            value: addressController.countryValue2,
                            onChanged: (value) {
                              var val = value as CountryModel2;
                              addressController.countryValue2 = val;
                        ...
                        DropdownButtonHideUnderline(
                          child: DropdownButton2(
                            ...
                            items: addressController.states2
                                .map((item) => DropdownMenuItem<StateModel2>(
                                      value: item,
                                      child: Text(
                                        item.name,
                                        style: const TextStyle(
                                ...
                                .toList(),
                            value: addressController.stateValue2,
                            onChanged: (value) {
                              var val = value as StateModel2;
                              addressController.stateValue2 = val;
                              addressController.update();
                            },
                            icon: const Icon(
                              Icons.keyboard_arrow_down_sharp,
                        ...
                        DropdownButtonHideUnderline(
                          child: DropdownButton2(
                            ...
                            items: addressController.cities2
                                .map((item) => DropdownMenuItem<CityModel2>(
                                      value: item,
                                      child: Text(
                                        item.name,
                                        style: const TextStyle(
                                ...
                                .toList(),
                            value: addressController.cityValue2,
                            onChanged: (value) {
                              var val = value as CityModel2;
                              addressController.cityValue2 = val;
                              addressController.update();
                            },
                            icon: const Icon(
                              Icons.keyboard_arrow_down_sharp,
