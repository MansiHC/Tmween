...
import 'package:tmween/screens/drawer/profile/updateProfile/change_password_screen.dart';
import 'package:tmween/screens/drawer/profile/updateProfile/deactivate_account_screen.dart';
...
class UpdateProfileScreenState extends State<UpdateProfileScreen> {
  ...
  Future<void> readSMS(
      EditProfileController otpController, bool fromMobile) async {
    String comingSms;
    try {
    ...
    if (comingSms.contains(LocaleKeys.appTitle.tr)) {
      ...
      if (fromMobile)
        otpController.mobileOTPController.text = intInStr
        ...
        otpController.emailOTPController.text = intInStr
            .allMatches(otpController.comingSms)
            .map((m) => m.group(0))
            .toString()
            .replaceAll('(', '')
                ...
                suffixIcon: InkWell(
                    onTap: () {
                      editAccountController
                        ...
                        print(
                            'jjjjj.....${editAccountController.mobileNumberController.text}');
