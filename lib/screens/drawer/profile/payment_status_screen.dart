...
class PaymentStatusScreen extends StatefulWidget {
  ...
  PaymentStatusScreen({Key? key, required this.isSuccess,required this.successText}) : super(key: key);
...
class PaymentStatusScreenState extends State<PaymentStatusScreen> {
  ...
  Widget _bottomView(PaymentStatusController paymentStatusController) {
          ...
          children: [
            ...
            Padding(padding:EdgeInsets.symmetric(horizontal: 10),child:Row(
              children: [
                ...
                5.widthBox,
                SvgPicture.asset( widget.isSuccess!?ImageConstanst.walletTickMarkIcon
                  :ImageConstanst.walletCrossIcon,height: 24,width: 24,),
               5.widthBox,
                Text(
    ...
    Padding(padding:EdgeInsets.symmetric(horizontal: 10),child: Row(children: [
              SvgPicture.asset(ImageConstanst.syberPay,height: 24,width: 24,),
              Padding(padding:EdgeInsets.symmetric(horizontal: 10),child:Text(
                'SyberPay',
                style: TextStyle(
                    fontSize: 15,
            ...
            RichText(
             text:TextSpan(text: 'Wallet Ref No: 3876543215 ',
              style: TextStyle(
                  fontSize: 13,
                  color: Colors.black45),
               children:[ TextSpan(text: 'Copy', style: TextStyle(
                   fontSize: 13,
