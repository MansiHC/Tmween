                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                      Expanded(child: Text('RECOMMENDATION FOR ALL PRODUCTS',
                        ...
                        Wrap(
                          ...
                          children: [
                        Text('View All',
                        style: TextStyle(color: Color(0xFF626262), fontSize: 11),
                      ),
                          Icon(Icons.keyboard_arrow_right,color: Color(0xFF626262),size: 16,)
                        ],)
                    ],),
                    10.heightBox,
                    ListView.builder(
                    ...
                    Row(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Expanded(child: Text('YOUR RECENTLY VIEWED ITEMS',
                          style: TextStyle(color: Color(0xFF333333), fontSize: 13,fontWeight: FontWeight.bold),
                        )),
                        Wrap(
                          crossAxisAlignment: WrapCrossAlignment.center,
                          ...
                          return Column(
                            children: [
                              CartRecentViewedProductContainer(
                                  ...
                                  cartController.cartRecentViewedProducts[index]),
                              15.heightBox
                            ],
                          );
                        }),
