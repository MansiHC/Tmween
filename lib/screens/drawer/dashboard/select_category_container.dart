...
import 'package:tmween/screens/drawer/category/sub_categories_screen.dart';
...
class SelectCategoryContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
        onTap: (){
          categoriesController.getSubCategories(category.id!, category.categoryName!, category.slugName!, language);
