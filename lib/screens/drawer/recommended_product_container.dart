                      ...
                      Expanded(
                        ...
                        children: [
                          ...
                          Wrap(
                            children: [
                              Text(
                                  '${LocaleKeys.sar.tr} ${recommendedProductModel.price}',
                                  textAlign: TextAlign.start,
                                  style: TextStyle(
                              ...
                              10.widthBox,
                              Text(
                                  '${LocaleKeys.sar.tr} ${recommendedProductModel.offerPrice}',
                                  textAlign: TextAlign.start,
                                  style: TextStyle(
                          ...
                          if (recommendedProductModel.isYouSave)
                            RichText(
                                ...
                                text: TextSpan(
                                    text:
                                        'You save ${LocaleKeys.sar.tr} ${recommendedProductModel.savePrice}! ',
                                    style: TextStyle(
                                        color: Color(0xFF3B963C), fontSize: 12),
                                    children: <InlineSpan>[
                                      TextSpan(
                                        text:
                                            '${recommendedProductModel.saveOffer}% ${LocaleKeys.off.tr}!',
                                        style: TextStyle(
                                          fontSize: 12,
                                          decoration:
