                      ...
                      Expanded(
                        ...
                        children: [
                          ...
                          Wrap(
                            children: [
                              Text(
                                  '${LocaleKeys.sar.tr} ${cartProductModel.price}',
                                  textAlign: TextAlign.start,
                                  style: TextStyle(
                          ...
                          Wrap(
                            children: List.generate(
                                cartProductModel.specifications.length,
                                (index) => Wrap(
                                      children: [
                                        Text(
                                            '${cartProductModel.specifications[index]['title']}: ',
                                            textAlign: TextAlign.start,
                                            style: TextStyle(
                                                color: Color(0xFF888888),
                                                fontSize: 12,
                                                fontWeight: FontWeight.bold)),
                                        Text(
                                            cartProductModel.specifications
                                                            .length -
                                                        1 ==
                                                    index
                          ...
                          if (!cartProductModel.inStock)
                            Text(
                                '${LocaleKeys.orderNowOnly.tr} ${cartProductModel.stockCount} ${LocaleKeys.leftInStock}!',
                                textAlign: TextAlign.start,
                                style: TextStyle(
                          ...
                          Wrap(
                            children: [
                              ...
                              Container(
                                ...
                                child: Center(
                                    child: Text(
                                        cartController.quntity.toString(),
