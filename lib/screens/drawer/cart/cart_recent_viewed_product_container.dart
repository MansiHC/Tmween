                        ...
                        children: [
                          ...
                          InkWell(
                              onTap: () {
                                print(
                                    '......${cartRecentViewedProductModel.id}');
                                if (cartController.wishListedProduct.contains(
                                    cartRecentViewedProductModel.id)) {
                                  cartController.removeWishlistProduct(
                                      cartRecentViewedProductModel.id,
                                      language);
                                } else {
                              ...
                              child: SvgPicture.asset(
                                cartController.wishListedProduct.contains(
                                        cartRecentViewedProductModel.id)
                                    ? ImageConstanst.likeFill
                                    : ImageConstanst.like,
                                color: cartController.wishListedProduct
                                        .contains(
                                            cartRecentViewedProductModel.id)
                                    ? Colors.red
                                    : Color(0xFF969696),
