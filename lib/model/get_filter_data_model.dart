class GetFilterDataModel {
  ...
  GetFilterDataModel({this.statusCode, this.statusMessage, this.message, this.data});
...
class GetFilterData {
 ...
 /* List<ProductData>? productData;
  ...
  GetFilterData({this.categoryName, this.categoryId, this.suppliersData, this.brand,
    this.productCategory, /* this.productData, this.productDataPagination,*/ this.maxPrice});
  ...
  GetFilterData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['suppliers_data'] != null) {
      ...
      json['suppliers_data'].forEach((v) { suppliersData!.add(new SuppliersData.fromJson(v)); });
    }
    if (json['brand'] != null) {
      brand = <Brand>[];
      json['brand'].forEach((v) { brand!.add(new Brand.fromJson(v)); });
    }
    if (json['product_category'] != null) {
      productCategory = <ProductCategory>[];
      json['product_category'].forEach((v) { productCategory!.add(new ProductCategory.fromJson(v)); });
    }
...
*/    maxPrice = json['max_price'];
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.suppliersData != null) {
      data['suppliers_data'] = this.suppliersData!.map((v) => v.toJson()).toList();
    }
    if (this.brand != null) {
      data['brand'] = this.brand!.map((v) => v.toJson()).toList();
    }
    if (this.productCategory != null) {
      data['product_category'] = this.productCategory!.map((v) => v.toJson()).toList();
    }
...
class SuppliersData {
  ...
  SuppliersData({this.supplierId, this.productId, this.isSystemSupplier, this.supplierName});
...
class ProductCategory {
  ...
  ProductCategory({this.id, this.categoryName, this.parentId, this.showInTopMenu, this.image, this.slugName, this.count, this.mainCategory});
...
ProductDataPagination({this.totalPages, this.next, this.previous, this.totalRecords});
